...
public class plain2xml extends AbstractTransformation {
    ...
    public void transform(TransformationInput ti, TransformationOutput to) throws StreamTransformationException {
        try {
            ZZamena("<?xml version=\"1.0\" encoding=\"windows-1251\" ?><BBB><row>", "</row></BBB>", "\r\n", "</row><row>", ti, to);
        } catch (Exception e) {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            plain2xml.ZZamena("<?xml version=\"1.0\" encoding=\"windows-1251\" ?><BBB><row>", "</row></BBB>", "\r\n", "</row><row>", is, os);
            os.close();
            is.close();
        } catch (Exception e) {
        }
